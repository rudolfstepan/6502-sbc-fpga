...
.PHONY: analyze roms sd-boot-image sd-boot-test-image test test-sd-boot-shadow \
        clean pix16 pipistrello pipistrello-hdmi-test pipistrello-6502-hdmi pipistrello-6502-sd-hdmi pipistrello-c64 tang_primer_20k tang_mega_138k tang_mega_138k-sbc tang_mega_138k-usb-hid tang_mega_138k-system16 tang_mega_138k-system16-flash tang_mega_138k-flash tang_mega_138k-hdmi-test tang_mega_138k-hdmi-test-flash tang_primer_console_138k d64-test-image test-d64 test-d64-map \
...
roms:
	$(PYTHON) tools/bin_to_vhdl_hex.py --size 0x4000 --output $(CHESS_ROM_HEX) sim/hex/rom_welcome.hex
	$(PYTHON) tools/bin_to_vhdl_hex.py --size 0x4000 --output $(SBC_ROM_HEX) sim/hex/rom_welcome.hex
	$(PYTHON) tools/bin_to_vhdl_hex.py --size 0x4000 --output $(SBC_EHBASIC_ROM_HEX) sim/hex/rom_welcome.hex
...
tang_mega_138k-usb-hid:
	$(MAKE) -C boards/tang_mega_138k/usb_hid
