...
(
	...
	output[4:0]      debug_sec_state,
	output[3:0]      debug_cmd_state,
	output           debug_cmd_error
);
...
wire[15:0]           clk_div;
assign debug_cmd_error = cmd_req_error;
