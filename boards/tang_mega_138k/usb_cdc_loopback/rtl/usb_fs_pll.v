// 50 MHz -> 60 MHz for the USB 1.1 SoftPHY and device controller.
// VCO = 50 MHz * 24 = 1200 MHz; CLKOUT0 = 1200 / 20 = 60 MHz.
module usb_fs_pll(output lock, output clk60, input clkin);
  wire vcc = 1'b1, gnd = 1'b0;
  wire c1,c2,c3,c4,c5,c6,fb;
  PLL PLL_inst (
    .LOCK(lock), .CLKOUT0(clk60), .CLKOUT1(c1), .CLKOUT2(c2),
