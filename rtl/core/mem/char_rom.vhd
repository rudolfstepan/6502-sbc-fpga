...
architecture rtl of char_rom is
  ...
  begin
    ...
    -- Chess piece glyphs (codes $80-$85, upper bank via glyph_hi). The chess PRG
    -- (sw/chess.s `pieces` table) prints these on the board; the square tile is
    -- the per-cell background ($9005 mode) and the piece is the foreground.
    --   $80 pawn  $81 knight  $82 bishop  $83 rook  $84 queen  $85 king
    -- Pawn
    r(16#80#*8 + 0) := x"18";
    r(16#80#*8 + 1) := x"3C";
    r(16#80#*8 + 2) := x"3C";
